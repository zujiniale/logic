...
É como uma receita: você segue as instruções na ordem certa e chega ao resultado esperado.

## Entrada, Processamento e Saída
- **Entrada:** os dados que você fornece ao programa (ex: duas notas)
...
4. Adicionar água no reservatório
5. Ligar a cafeteira
